...
<div class="container" style="min-height: 60vh; display: flex; align-items: center; justify-content: center; text-align: center; padding: 4rem 1rem;">
    <div>
        <h1 style="font-family: var(--ff-display); font-size: 8rem; color: var(--neon-pink); line-height: 1; margin-bottom: 1rem; text-shadow: var(--glow-pink);">403</h1>
        <h2 style="font-family: var(--ff-body); font-size: 1.5rem; color: var(--text); margin-bottom: 1.5rem;">Akses Ditolak</h2>
